	...
	return (
		<section className="text-center max-w-lg mx-auto flex flex-col    py-32">
			...
			<p className="mt-2 text-sm text-stone-500">
				...
				in your next React project. With a list of responsive components, you
				can build with ease.
			</p>

			<p className="text-sm mt-3 flex space-x-1 items-center mx-auto text-stone-500 bg-white py-3 px-4 rounded-full shadow-md">
